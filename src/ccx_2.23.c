...
int main(int argc,char *argv[])
{
  ...
  printf("************************************************************\n\n");
  printf("You are using an executable made on Thu Sep 17 10:01:44 PM CEST 2026\n");
  fflush(stdout);
  ...
  while(istat>=0){
	...
	NNEW(prop,double,nprop_);
      ...
      /* Added ||(ne_!=0) and +36*ne_ / +ne_ / +24*ne_ to allocate offsets/normals for custom user elements (e.g. UB31) */
