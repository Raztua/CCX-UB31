...
!
c         if(lakon(i)(1:4).eq.'US45') then
c            call extrapolateshell_us45(yi,yn,ipkon,inum,kon,lakon,
c     &           nfield,nk,ne,mi,ndim,orab,ielorien,co,iorienloc,cflag,
c     &           ielmat,thicke,ielprop,prop,i,iflag)
c         elseif(lakon(i)(1:3).eq.'US3') then
c            call extrapolateshell_us3(yi,yn,ipkon,inum,kon,lakon,
c     &           nfield,nk,ne,mi,ndim,orab,ielorien,co,iorienloc,cflag,
c     &           ielmat,thicke,ielprop,prop,i,iflag)
c         else
            cycle
