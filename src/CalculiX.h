...
void FORTRAN(getub31stx,(ITG *nelem,double *out_array));
void FORTRAN(getub31for,(ITG *nelem,double *out_array));
void FORTRAN(iscodecheckactive,(ITG *iactive));
void FORTRAN(getcodecheckuc,(ITG *nelem,double *out_array));
void FORTRAN(getcodecheckstationuc,(ITG *nelem,ITG *istation,double *out_array));
void FORTRAN(run_beam_codecheck,(double *co,ITG *kon,ITG *ipkon,char *lakon,
				ITG *ne,ITG *nk,ITG *ielmat,char *matname,
				ITG *istep,ITG *iinc,ITG *mi,ITG *ielprop,
				double *prop,char *jobnamec,char *set,
				ITG *nset,ITG *istartset,ITG *iendset,
				ITG *ialset));
